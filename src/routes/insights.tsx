  ...
  head: () => ({
    meta: [
      { title: "Insights · CivicRadar" },
      {
        name: "description",
        content:
          "Emerging clusters, action scores, actor breakdown and recommended actions for the Bengaluru pilot.",
      },
    ],
  }),
  component: Insights,
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
        From scattered civic issue signals to ranked, actionable hyperlocal opportunities. Clusters
        generated by the CivicRadar intelligence layer in demo mode — model adapter ready for
      ...
      {/* Action scorecards */}
      <section className="mt-12">
        <SectionTitle icon={Target}>Action scorecards</SectionTitle>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-xl border border-primary/40 bg-primary/[0.05] p-4">
            ...
            <p className="mt-2 text-sm">
              {all.length} structured Civic Issue Cards · {clusters.length} active clusters · ranked
              by signal strength · routed to recommended actors with concrete suggested actions.
            </p>
